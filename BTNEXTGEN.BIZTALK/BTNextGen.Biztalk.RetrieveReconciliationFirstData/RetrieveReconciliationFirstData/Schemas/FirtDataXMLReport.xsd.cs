namespace RetrieveReconciliationFirstData {
    ...
    [SchemaRoots(new string[] {@"testDataNode"})]
    public sealed class FirstDataXMLReport : Microsoft.XLANGs.BaseTypes.SchemaBase {
