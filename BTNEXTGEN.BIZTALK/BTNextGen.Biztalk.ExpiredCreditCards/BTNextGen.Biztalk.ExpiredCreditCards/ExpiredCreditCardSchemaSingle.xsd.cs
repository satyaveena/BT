namespace BTNextGen.Biztalk.ExpiredCreditCards {
    ...
    [Schema(@"http://BTNextGen.Biztalk.ExpiredCreditCards.CreditCardData",@"CreditCardData")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"CreditCardData"})]
    public sealed class ExpiredCreditCardSchemaSingle : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://BTNextGen.Biztalk.ExpiredCreditCards.CreditCardData"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://BTNextGen.Biztalk.ExpiredCreditCards.CreditCardData"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""CreditCardData"">
    <xs:complexType>
      <xs:sequence>
        ...
        public ExpiredCreditCardSchemaSingle() {
        }
