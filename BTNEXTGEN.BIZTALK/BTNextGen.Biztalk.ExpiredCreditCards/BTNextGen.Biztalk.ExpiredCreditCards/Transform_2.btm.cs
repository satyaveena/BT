...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0"" version=""1.0"" xmlns:s0=""http://schemas.microsoft.com/CommerceServer/2004/02/Expressions"">
  ...
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/s0:CLAUSE"" />
  </xsl:template>
  <xsl:template match=""/s0:CLAUSE"" />
</xsl:stylesheet>";
        
        private const string _strArgList = @"<ExtensionObjects />";
        
        private const string _strSrcSchemasList0 = @"BTNextGen.BizTalk.CS.Profiles.Schemas.ProfilesQueryExpr";
        
        private const global::BTNextGen.BizTalk.CS.Profiles.Schemas.ProfilesQueryExpr _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"BTNextGen.BizTalk.CS.Profiles.Schemas.ProfilesQueryExpr";
                return _SrcSchemas;
            }
        }
