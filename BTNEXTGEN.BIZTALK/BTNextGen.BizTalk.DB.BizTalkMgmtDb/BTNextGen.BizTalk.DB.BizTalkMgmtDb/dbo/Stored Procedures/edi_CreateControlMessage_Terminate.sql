CREATE PROCEDURE [dbo].[edi_CreateControlMessage_Terminate] (
	@BatchId bigint,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[edi_CreateControlMessage_Terminate] TO [BTS_ADMIN_USERS]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[edi_CreateControlMessage_Terminate] TO [BTS_OPERATORS]
    AS [dbo];
