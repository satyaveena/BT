CREATE PROCEDURE [dbo].[sp_BackupBizTalkLog] @seq nvarchar (128), @path nvarchar (3000), @BackupLocation nvarchar(4000) OUTPUT, @bCompression BIT = 0
AS
begin
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_BackupBizTalkLog] TO [BTS_BACKUP_USERS]
    AS [dbo];
