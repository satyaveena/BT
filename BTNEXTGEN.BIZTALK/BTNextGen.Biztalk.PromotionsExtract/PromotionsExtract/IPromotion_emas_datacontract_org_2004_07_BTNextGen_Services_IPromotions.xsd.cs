namespace BTNextGen.Biztalk.PromotionsExtract {
    ...
    public sealed class IPromotion_emas_datacontract_org_2004_07_BTNextGen_Services_IPromotions : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:tns=""http://schemas.datacontract.org/2004/07/BTNextGen.Services.IPromotions"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.datacontract.org/2004/07/BTNextGen.Services.IPromotions"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  ...
  <xs:element name=""Promotion"" nillable=""true"" type=""tns:Promotion"" />
        ...
        public IPromotion_emas_datacontract_org_2004_07_BTNextGen_Services_IPromotions() {
        }
        ...
        [Schema(@"http://schemas.datacontract.org/2004/07/BTNextGen.Services.IPromotions",@"ArrayOfPromotion")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.datacontract.org/2004/07/BTNextGen.Services.IPromotions",@"Promotion")]
        [System.SerializableAttribute()]
