      ...
      <ns0:Rows>
        <xsl:for-each select=""s1:StoredProcedureResultSet0"">
          <xsl:for-each select=""s0:StoredProcedureResultSet0"">
            ...
            <xsl:variable name=""var:v6"" select=""userCSharp:StringConcat(&quot;TransNum_&quot; , string(s0:TransNum/text()))"" />
...
public string DateCurrentDateTime()
{
	...
	return retval;
        ...
        private const global::BTNextGen.Biztalk.BAMAlerts.TableOperation_dbo_BT_BAMAlertHistory.Insert _trgSchemaTypeReference0 = null;
