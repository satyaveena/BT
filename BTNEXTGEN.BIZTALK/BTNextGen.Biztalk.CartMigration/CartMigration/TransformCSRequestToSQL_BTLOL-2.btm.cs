namespace CartMigration {
    ...
    public sealed class Copy_of_TransformCSRequestToSQL_BTLOL : global::Microsoft.XLANGs.BaseTypes.TransformBase {
  ...
  <xsl:template match=""/s0:CartMigrationRequestBackup"">
    <ns0:procSetBasketError>
      ...
      <xsl:for-each select=""/s0:CartMigrationRequestBackup/BasketList/BasketDetails"">
        <xsl:variable name=""var:v2"" select=""userCSharp:LogicalEq(string(LegacySourceSystem/text()) , &quot;BTLOL&quot;)"" />
