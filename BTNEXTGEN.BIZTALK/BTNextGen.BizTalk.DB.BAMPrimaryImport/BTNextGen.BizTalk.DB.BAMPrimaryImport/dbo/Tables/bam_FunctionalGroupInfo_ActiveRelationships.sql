CREATE TABLE [dbo].[bam_FunctionalGroupInfo_ActiveRelationships] (
...
CREATE CLUSTERED INDEX [CI_ActivityIDandOtherActivityNameandID]
    ON [dbo].[bam_FunctionalGroupInfo_ActiveRelationships]([ActivityID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);
