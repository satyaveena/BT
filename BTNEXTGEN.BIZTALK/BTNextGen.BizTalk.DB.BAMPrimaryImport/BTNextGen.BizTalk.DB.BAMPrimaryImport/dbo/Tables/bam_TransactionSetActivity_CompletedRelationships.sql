CREATE TABLE [dbo].[bam_TransactionSetActivity_CompletedRelationships] (
...
CREATE CLUSTERED INDEX [CI_RecordIDandOtherActivityNameandID]
    ON [dbo].[bam_TransactionSetActivity_CompletedRelationships]([RecordID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);


GO
CREATE NONCLUSTERED INDEX [NCI_ActivityID]
    ON [dbo].[bam_TransactionSetActivity_CompletedRelationships]([ActivityID] ASC);
