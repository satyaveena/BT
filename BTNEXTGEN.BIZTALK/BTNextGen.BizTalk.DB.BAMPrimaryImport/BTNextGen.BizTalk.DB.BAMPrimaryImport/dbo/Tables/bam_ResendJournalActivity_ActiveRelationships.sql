CREATE TABLE [dbo].[bam_ResendJournalActivity_ActiveRelationships] (
...
CREATE CLUSTERED INDEX [CI_ActivityIDandOtherActivityNameandID]
    ON [dbo].[bam_ResendJournalActivity_ActiveRelationships]([ActivityID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);
