CREATE TABLE [dbo].[bam_AS2MessageActivity_CompletedRelationships] (
...
CREATE CLUSTERED INDEX [CI_RecordIDandOtherActivityNameandID]
    ON [dbo].[bam_AS2MessageActivity_CompletedRelationships]([RecordID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);


GO
CREATE NONCLUSTERED INDEX [NCI_ActivityID]
    ON [dbo].[bam_AS2MessageActivity_CompletedRelationships]([ActivityID] ASC);
