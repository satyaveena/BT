CREATE TABLE [dbo].[bam_BatchInterchangeActivity_ActiveRelationships] (
...
CREATE CLUSTERED INDEX [CI_ActivityIDandOtherActivityNameandID]
    ON [dbo].[bam_BatchInterchangeActivity_ActiveRelationships]([ActivityID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);
