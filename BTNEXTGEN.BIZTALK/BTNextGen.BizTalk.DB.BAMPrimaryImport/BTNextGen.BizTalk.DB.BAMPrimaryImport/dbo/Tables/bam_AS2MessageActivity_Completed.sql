CREATE TABLE [dbo].[bam_AS2MessageActivity_Completed] (
...
CREATE UNIQUE NONCLUSTERED INDEX [NCI_ActivityID]
    ON [dbo].[bam_AS2MessageActivity_Completed]([ActivityID] ASC);


GO
CREATE NONCLUSTERED INDEX [NCI_LastModified]
    ON [dbo].[bam_AS2MessageActivity_Completed]([LastModified] ASC);
