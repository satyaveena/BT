CREATE TABLE [dbo].[bam_ResendJournalActivity_CompletedRelationships] (
...
CREATE CLUSTERED INDEX [CI_RecordIDandOtherActivityNameandID]
    ON [dbo].[bam_ResendJournalActivity_CompletedRelationships]([RecordID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);


GO
CREATE NONCLUSTERED INDEX [NCI_ActivityID]
    ON [dbo].[bam_ResendJournalActivity_CompletedRelationships]([ActivityID] ASC);
