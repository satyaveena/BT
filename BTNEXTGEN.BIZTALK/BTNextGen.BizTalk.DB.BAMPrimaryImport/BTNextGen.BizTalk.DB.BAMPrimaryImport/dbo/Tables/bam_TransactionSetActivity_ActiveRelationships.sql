CREATE TABLE [dbo].[bam_TransactionSetActivity_ActiveRelationships] (
...
CREATE CLUSTERED INDEX [CI_ActivityIDandOtherActivityNameandID]
    ON [dbo].[bam_TransactionSetActivity_ActiveRelationships]([ActivityID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);
