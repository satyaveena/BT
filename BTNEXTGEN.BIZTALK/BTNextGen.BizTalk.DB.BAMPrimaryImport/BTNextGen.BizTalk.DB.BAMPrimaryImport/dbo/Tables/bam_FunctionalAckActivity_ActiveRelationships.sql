CREATE TABLE [dbo].[bam_FunctionalAckActivity_ActiveRelationships] (
...
CREATE CLUSTERED INDEX [CI_ActivityIDandOtherActivityNameandID]
    ON [dbo].[bam_FunctionalAckActivity_ActiveRelationships]([ActivityID] ASC, [ReferenceName] ASC, [ReferenceData] ASC);
