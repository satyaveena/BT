CREATE FUNCTION [dbo].[bts_SentFunctionalAcksOfInterchange]
(	
...
(
	...
	faa.AckProcessingStatus = 2
)
GO
GRANT SELECT
    ON OBJECT::[dbo].[bts_SentFunctionalAcksOfInterchange] TO [BTS_ADMIN_USERS]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[bts_SentFunctionalAcksOfInterchange] TO [BTS_OPERATORS]
    AS [dbo];
