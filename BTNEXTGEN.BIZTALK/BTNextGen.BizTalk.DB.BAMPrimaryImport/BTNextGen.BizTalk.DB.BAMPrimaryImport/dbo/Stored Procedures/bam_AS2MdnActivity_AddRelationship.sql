CREATE PROCEDURE [dbo].[bam_AS2MdnActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_AS2MdnActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_AS2MdnActivity_AddRelationship] TO [bam_AS2MdnActivity_EventWriter]
    AS [dbo];
