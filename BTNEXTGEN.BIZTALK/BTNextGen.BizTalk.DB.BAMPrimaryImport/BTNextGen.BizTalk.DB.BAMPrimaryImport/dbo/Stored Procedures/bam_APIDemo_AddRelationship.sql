CREATE PROCEDURE [dbo].[bam_APIDemo_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_APIDemo_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_APIDemo_AddRelationship] TO [bam_APIDemo_EventWriter]
    AS [dbo];
