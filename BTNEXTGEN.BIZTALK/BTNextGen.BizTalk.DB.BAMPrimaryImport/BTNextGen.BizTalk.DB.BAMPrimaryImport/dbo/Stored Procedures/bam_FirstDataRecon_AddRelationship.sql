CREATE PROCEDURE [dbo].[bam_FirstDataRecon_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_FirstDataRecon_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_FirstDataRecon_AddRelationship] TO [bam_FirstDataRecon_EventWriter]
    AS [dbo];
