CREATE PROCEDURE [dbo].[bam_FunctionalGroupInfo_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_FunctionalGroupInfo_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_FunctionalGroupInfo_PrimaryImport] TO [bam_FunctionalGroupInfo_EventWriter]
    AS [dbo];
