CREATE PROCEDURE [dbo].[bam_BatchingActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_BatchingActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_BatchingActivity_AddRelationship] TO [bam_BatchingActivity_EventWriter]
    AS [dbo];
