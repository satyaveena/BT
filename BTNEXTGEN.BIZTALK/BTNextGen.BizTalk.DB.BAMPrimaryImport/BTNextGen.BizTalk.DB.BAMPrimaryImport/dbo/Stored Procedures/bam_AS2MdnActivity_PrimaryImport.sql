CREATE PROCEDURE [dbo].[bam_AS2MdnActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_AS2MdnActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_AS2MdnActivity_PrimaryImport] TO [bam_AS2MdnActivity_EventWriter]
    AS [dbo];
