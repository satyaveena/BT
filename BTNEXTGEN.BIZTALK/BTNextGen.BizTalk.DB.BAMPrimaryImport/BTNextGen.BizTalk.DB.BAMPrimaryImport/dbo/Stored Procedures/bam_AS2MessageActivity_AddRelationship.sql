CREATE PROCEDURE [dbo].[bam_AS2MessageActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_AS2MessageActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_AS2MessageActivity_AddRelationship] TO [bam_AS2MessageActivity_EventWriter]
    AS [dbo];
