CREATE PROCEDURE [dbo].[bam_ERPOrders_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_ERPOrders_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_ERPOrders_AddRelationship] TO [bam_ERPOrders_EventWriter]
    AS [dbo];
