CREATE PROCEDURE [dbo].[bam_EmailFromFile_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_EmailFromFile_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_EmailFromFile_AddRelationship] TO [bam_EmailFromFile_EventWriter]
    AS [dbo];
