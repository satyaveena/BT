CREATE PROCEDURE [dbo].[bam_BusinessMessageJournal_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_BusinessMessageJournal_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_BusinessMessageJournal_AddRelationship] TO [bam_BusinessMessageJournal_EventWriter]
    AS [dbo];
