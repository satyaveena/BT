CREATE PROCEDURE [dbo].[bam_ResendJournalActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_ResendJournalActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_ResendJournalActivity_AddRelationship] TO [bam_ResendJournalActivity_EventWriter]
    AS [dbo];
