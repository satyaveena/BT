CREATE PROCEDURE [dbo].[bam_InterchangeAckActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_InterchangeAckActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_InterchangeAckActivity_AddRelationship] TO [bam_InterchangeAckActivity_EventWriter]
    AS [dbo];
