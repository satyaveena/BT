CREATE PROCEDURE [dbo].[bam_PaymentERPTxn_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_PaymentERPTxn_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_PaymentERPTxn_AddRelationship] TO [bam_PaymentERPTxn_EventWriter]
    AS [dbo];
