CREATE PROCEDURE [dbo].[bam_FunctionalAckActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_FunctionalAckActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_FunctionalAckActivity_PrimaryImport] TO [bam_FunctionalAckActivity_EventWriter]
    AS [dbo];
