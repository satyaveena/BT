CREATE PROCEDURE [dbo].[bam_BusinessMessageJournal_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_BusinessMessageJournal_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_BusinessMessageJournal_PrimaryImport] TO [bam_BusinessMessageJournal_EventWriter]
    AS [dbo];
