CREATE PROCEDURE [dbo].[bam_FunctionalGroupInfo_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_FunctionalGroupInfo_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_FunctionalGroupInfo_AddRelationship] TO [bam_FunctionalGroupInfo_EventWriter]
    AS [dbo];
