CREATE PROCEDURE [dbo].[bam_InterchangeAckActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_InterchangeAckActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_InterchangeAckActivity_PrimaryImport] TO [bam_InterchangeAckActivity_EventWriter]
    AS [dbo];
