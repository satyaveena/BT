CREATE PROCEDURE [dbo].[bam_EmailFromFile_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_EmailFromFile_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_EmailFromFile_PrimaryImport] TO [bam_EmailFromFile_EventWriter]
    AS [dbo];
