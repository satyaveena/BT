CREATE PROCEDURE [dbo].[bam_Cybersource Settlement Feed_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_Cybersource Settlement Feed_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_Cybersource Settlement Feed_AddRelationship] TO [bam_Cybersource Settlement Feed_EventWriter]
    AS [dbo];
