CREATE PROCEDURE [dbo].[bam_ExpiredCreditCards_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_ExpiredCreditCards_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_ExpiredCreditCards_AddRelationship] TO [bam_ExpiredCreditCards_EventWriter]
    AS [dbo];
