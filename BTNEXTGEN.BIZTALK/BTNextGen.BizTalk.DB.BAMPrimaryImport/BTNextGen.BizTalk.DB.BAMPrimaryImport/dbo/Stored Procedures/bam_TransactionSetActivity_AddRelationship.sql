CREATE PROCEDURE [dbo].[bam_TransactionSetActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_TransactionSetActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_TransactionSetActivity_AddRelationship] TO [bam_TransactionSetActivity_EventWriter]
    AS [dbo];
