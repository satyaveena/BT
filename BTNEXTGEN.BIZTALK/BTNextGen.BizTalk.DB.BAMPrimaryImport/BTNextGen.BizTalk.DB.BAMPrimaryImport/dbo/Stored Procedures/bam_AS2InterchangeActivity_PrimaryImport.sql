CREATE PROCEDURE [dbo].[bam_AS2InterchangeActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_AS2InterchangeActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_AS2InterchangeActivity_PrimaryImport] TO [bam_AS2InterchangeActivity_EventWriter]
    AS [dbo];
