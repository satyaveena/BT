CREATE PROCEDURE [dbo].[bam_BatchInterchangeActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_BatchInterchangeActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_BatchInterchangeActivity_PrimaryImport] TO [bam_BatchInterchangeActivity_EventWriter]
    AS [dbo];
