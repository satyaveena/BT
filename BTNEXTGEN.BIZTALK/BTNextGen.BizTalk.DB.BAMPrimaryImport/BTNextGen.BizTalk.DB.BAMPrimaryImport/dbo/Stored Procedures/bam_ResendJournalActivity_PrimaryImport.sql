CREATE PROCEDURE [dbo].[bam_ResendJournalActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_ResendJournalActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_ResendJournalActivity_PrimaryImport] TO [bam_ResendJournalActivity_EventWriter]
    AS [dbo];
