CREATE PROCEDURE [dbo].[bam_ResendTrackingActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_ResendTrackingActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_ResendTrackingActivity_AddRelationship] TO [bam_ResendTrackingActivity_EventWriter]
    AS [dbo];
