CREATE PROCEDURE [dbo].[bam_InterchangeStatusActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_InterchangeStatusActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_InterchangeStatusActivity_PrimaryImport] TO [bam_InterchangeStatusActivity_EventWriter]
    AS [dbo];
