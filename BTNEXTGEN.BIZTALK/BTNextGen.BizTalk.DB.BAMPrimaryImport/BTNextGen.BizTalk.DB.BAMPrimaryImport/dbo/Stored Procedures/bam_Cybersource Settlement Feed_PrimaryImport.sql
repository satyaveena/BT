CREATE PROCEDURE [dbo].[bam_Cybersource Settlement Feed_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_Cybersource Settlement Feed_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_Cybersource Settlement Feed_PrimaryImport] TO [bam_Cybersource Settlement Feed_EventWriter]
    AS [dbo];
