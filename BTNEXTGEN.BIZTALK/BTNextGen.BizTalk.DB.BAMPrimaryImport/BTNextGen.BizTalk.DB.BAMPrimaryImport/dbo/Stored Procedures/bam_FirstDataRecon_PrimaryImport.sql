CREATE PROCEDURE [dbo].[bam_FirstDataRecon_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_FirstDataRecon_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_FirstDataRecon_PrimaryImport] TO [bam_FirstDataRecon_EventWriter]
    AS [dbo];
