CREATE PROCEDURE [dbo].[bam_ExpiredCreditCards_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_ExpiredCreditCards_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_ExpiredCreditCards_PrimaryImport] TO [bam_ExpiredCreditCards_EventWriter]
    AS [dbo];
