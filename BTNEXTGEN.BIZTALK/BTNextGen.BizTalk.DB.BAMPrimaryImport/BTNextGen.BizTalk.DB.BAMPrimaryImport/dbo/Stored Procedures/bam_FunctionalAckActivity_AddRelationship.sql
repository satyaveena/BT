CREATE PROCEDURE [dbo].[bam_FunctionalAckActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_FunctionalAckActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_FunctionalAckActivity_AddRelationship] TO [bam_FunctionalAckActivity_EventWriter]
    AS [dbo];
