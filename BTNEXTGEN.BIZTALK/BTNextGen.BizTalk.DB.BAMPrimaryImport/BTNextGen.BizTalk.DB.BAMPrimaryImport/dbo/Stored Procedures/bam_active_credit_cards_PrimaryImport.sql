CREATE PROCEDURE [dbo].[bam_active_credit_cards_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_active_credit_cards_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_active_credit_cards_PrimaryImport] TO [bam_active_credit_cards_EventWriter]
    AS [dbo];
