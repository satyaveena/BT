CREATE PROCEDURE [dbo].[bam_AS2InterchangeActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_AS2InterchangeActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_AS2InterchangeActivity_AddRelationship] TO [bam_AS2InterchangeActivity_EventWriter]
    AS [dbo];
