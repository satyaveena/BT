CREATE PROCEDURE [dbo].[bam_active_credit_cards_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_active_credit_cards_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_active_credit_cards_AddRelationship] TO [bam_active_credit_cards_EventWriter]
    AS [dbo];
