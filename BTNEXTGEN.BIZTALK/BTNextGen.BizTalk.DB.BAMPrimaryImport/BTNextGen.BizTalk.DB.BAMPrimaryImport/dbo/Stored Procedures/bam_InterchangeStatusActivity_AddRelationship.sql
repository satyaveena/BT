CREATE PROCEDURE [dbo].[bam_InterchangeStatusActivity_AddRelationship]
      (
    ...
    BEGIN
              ...
              INSERT [dbo].[bam_InterchangeStatusActivity_ActiveRelationships](ActivityID, ReferenceType, ReferenceName, ReferenceData, ReferenceDataExtend, LongReferenceData)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_InterchangeStatusActivity_AddRelationship] TO [bam_InterchangeStatusActivity_EventWriter]
    AS [dbo];
