CREATE PROCEDURE [dbo].[bam_TransactionSetActivity_PrimaryImport]
      (
    ...
    BEGIN
              ...
              BEGIN
                  ...
                  DELETE 
                  FROM [dbo].[bam_TransactionSetActivity_Continuations] 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[bam_TransactionSetActivity_PrimaryImport] TO [bam_TransactionSetActivity_EventWriter]
    AS [dbo];
