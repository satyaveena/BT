...
<xs:schema xmlns=""BTNextGen.BizTalk.ERPOrders.Schemas.ERPOrdentBulk"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""BTNextGen.BizTalk.ERPOrders.Schemas.ERPOrdentBulk"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
  ...
  <xs:element name=""ORDENT"">
    <xs:annotation>
      <xs:appinfo>
        ...
        <b:properties>
          <b:property distinguished=""true"" xpath=""/*[local-name()='ORDENT' and namespace-uri()='BTNextGen.BizTalk.ERPOrders.Schemas.ERPOrdentBulk']/*[local-name()='HeadRefInfo' and namespace-uri()='']/*[local-name()='RefInfo' and namespace-uri()='']/*[local-name()='REFNUM' and namespace-uri()='']/*[local-name()='Value' and namespace-uri()='']"" />
        </b:properties>
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element maxOccurs=""unbounded"" name=""Details"">
          <xs:annotation>
            <xs:appinfo>
              <b:recordInfo structure=""delimited"" preserve_delimiter_for_empty_data=""true"" suppress_trailing_delimiters=""false"" sequence_number=""7"" child_delimiter_type=""hex"" child_delimiter=""0x0D 0x0A"" />
            </xs:appinfo>
          </xs:annotation>
          <xs:complexType>
        ...
        <xs:element name=""End"">
          <xs:annotation>
            <xs:appinfo>
              <b:recordInfo sequence_number=""9"" structure=""delimited"" preserve_delimiter_for_empty_data=""true"" suppress_trailing_delimiters=""false"" />
            </xs:appinfo>
          </xs:annotation>
          <xs:complexType>
            <xs:sequence>
