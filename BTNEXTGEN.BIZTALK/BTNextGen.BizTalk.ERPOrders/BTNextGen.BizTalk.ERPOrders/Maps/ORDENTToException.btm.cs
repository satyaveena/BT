namespace BTNextGen.BizTalk.ERPOrders.Maps {
    ...
    public sealed class ORDENTToException : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 userCSharp"" version=""1.0"" xmlns:s0=""BTNextGen.BizTalk.ERPOrders.Schemas.ERPOrdentCDF"" xmlns:ns0=""BTNextGen.BizTalk.ERPOrders.Schemas.NGExceptionMessage"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  <xsl:output omit-xml-declaration=""yes"" method=""xml"" version=""1.0"" />
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/s0:ORDENT"" />
  </xsl:template>
  <xsl:template match=""/s0:ORDENT"">
    <xsl:variable name=""var:v1"" select=""userCSharp:StringUpperCase(&quot;Successful ORDENT CDF Translation&quot;)"" />
    <ns0:Exception>
      <ErrorDetail>
        <ErrDetail>
...
public string StringUpperCase(string str)
{
	...
	return str.ToUpper(System.Globalization.CultureInfo.InvariantCulture);
        ...
        private const string _strSrcSchemasList0 = @"BTNextGen.BizTalk.ERPOrders.Schemas.ERPOrdentCDF";
        
        private const global::BTNextGen.BizTalk.ERPOrders.Schemas.ERPOrdentCDF _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"BTNextGen.BizTalk.ERPOrders.Schemas.ERPOrdentCDF";
                return _SrcSchemas;
            }
        }
