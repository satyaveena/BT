namespace BTNextGen.Biztalk.BasketMigration {
    ...
    public sealed class GetBasketIDTypedPolling_627 : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:tns=""http://schemas.microsoft.com/Sql/2008/05/TypedPolling/_x0036_27"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/Sql/2008/05/TypedPolling/_x0036_27"" version=""1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
      <fileNameHint xmlns=""http://schemas.microsoft.com/servicemodel/adapters/metadata/xsd"">TypedPolling.627</fileNameHint>
    </xs:appinfo>
  </xs:annotation>
  <xs:complexType name=""TypedPollingResultSet0"">
    <xs:sequence>
      <xs:element minOccurs=""0"" maxOccurs=""1"" name=""OrderGroupID"" nillable=""true"" type=""xs:string"" />
    </xs:sequence>
  </xs:complexType>
  ...
  <xs:element name=""TypedPolling"">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        public GetBasketIDTypedPolling_627() {
        }
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/_x0036_27",@"TypedPollingResultSet0")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/_x0036_27",@"ArrayOfTypedPollingResultSet0")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/_x0036_27",@"TypedPolling")]
        [System.SerializableAttribute()]
