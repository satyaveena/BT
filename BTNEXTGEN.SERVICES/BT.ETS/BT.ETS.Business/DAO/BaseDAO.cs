    ...
    public abstract class BaseDAO
    {
        ...
        protected void HandleException(SqlCommand command, string procName = "")
        {
            ...
            if (returnCode == 200 || returnCode == 203)
                // do not throw Exception for errors:
                //             200- "Items validation failed" from procETSInsertCarts
                //             203- "Products validation failed" from procETSDupCheck, procETSGetPricingRequests
                return;
