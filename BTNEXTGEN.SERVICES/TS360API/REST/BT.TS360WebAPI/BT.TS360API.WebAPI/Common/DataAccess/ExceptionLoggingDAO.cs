...
namespace BT.TS360API.WebAPI.Common.DataAccess
{
    public class ExceptionLoggingDAO
    {
        ...
        {
           _sqlConn = new SqlConnection(AppSetting.ExceptionLoggingDatabaseConnectionString);
        }
        ...
        public void LogRequest(string webMethod, string requestMessage, string responseMessage, string vendorAPIKey, string exceptionMessage) 
        {
            ...
            DatabaseHelper.ExecuteNonQuery(Constants.StoredProcedure.UPDATE_LOG_REQUEST, arr, _sqlConn);
        }
    }
}