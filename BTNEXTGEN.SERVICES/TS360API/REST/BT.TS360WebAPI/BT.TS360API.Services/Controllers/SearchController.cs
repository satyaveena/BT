...
namespace BT.TS360API.Services.Controllers
{
    public partial class SearchController : ApiController
    {
        ...
        public async Task<AppServiceResult<List<SiteTermObject>>> GetProductDuplicateIndicator([FromBody] ProductDuplicateIndicatorRequest request)
        {
            ...
            try
            {
                ...
                return await _searchService.GetProductDuplicateIndicator(request.btKeyList, request.btEKeyList, request.basketId,
                    request.isRequiredCheckDupCarts, request.isRequiredCheckDupOrder, request.UserId, request.DefaultDownloadedCarts, request.OrgId);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("appservice/searchservice/GetPrimaryCartLineItemsForAltFormats")]
        public async Task<AppServiceResult<List<SiteTermObject>>> GetPrimaryCartLineItemsForAltFormats(GetPrimaryCartGridDataRequest request)
        {
            var result = new AppServiceResult<List<SiteTermObject>>();
            try
            {
                result.Data = await _searchService.GetPrimaryCartLineItemsForAltFormats(request.BTKeyList, request.PrimaryCartId);
                return result;
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("appservice/searchservice/GetBTKeyListForTitleList")]
        public async Task<AppServiceResult<BTKeyListForTitleListResponse>> GetBTKeyListForTitleList(BTKeyListForTitleListRequest request)
        {
            try
            {
                var ajaxResult = new AppServiceResult<BTKeyListForTitleListResponse>();
                ajaxResult.Data = await _searchService.GetBTKeyListForTitleList(request);
        ...
        public async Task<AppServiceResult<GetCalendarDataResponse>> GetCalendarData(GetCalendarDataRequest request)
        {
            var result = new AppServiceResult<GetCalendarDataResponse>();
            result.Status = AppServiceStatus.Success;
            try
            {
                var task1 = _searchService.GetCalendarData(request);
                var task2 = _searchService.UpdateUserNRCProductTypes(request.UserId, request.ProductTypesList);

                await Task.WhenAll(task1, task2);

                result.Data = task1.Result;
        ...
        public AppServiceResult<GetNRCFeaturedProductsResponse> GetNRCFeaturedProductsByBTKeys(FeaturedProductsByBTKeysRequest request)
        {
            ...
            try
            {
                result.Data = _searchService.GetNRCFeaturedProductsByBTKeys(request.BTKeys, request.BatchSize);
            }
            catch (Exception ex)
            {
                result.Data = null;
        ...
        [HttpPost]
        [Route("appservice/searchservice/GetCirculationByISBN")]
        public async Task<AppServiceResult<Axis360InventoryResponse>> GetCirculationByISBN(Axis360CirculationRequest request)
        {
            var result = new AppServiceResult<Axis360InventoryResponse>();
            result.Status = AppServiceStatus.Success;
            try
            {
                result.Data = await _searchService.GetCirculationByISBN(request);
            }
            catch (Exception ex)
            {
                result.Status = AppServiceStatus.Fail;
                result.ErrorMessage = CommonErrorMessage.UnexpectedErrorMessage;
                Logger.WriteLog(ex, "GetCirculationByISBN");
            }
            return result;
        }

        [HttpPost]
        [Route("appservice/searchservice/CheckForCirculationByISBN")]
        public async Task<AppServiceResult<Axis360CheckInventoryResponse>> CheckForCirculationByISBN(Axis360CheckCirculationRequest request)
        {
            var result = new AppServiceResult<Axis360CheckInventoryResponse>();
            result.Status = AppServiceStatus.Success;
            try
            {
                result.Data = await _searchService.CheckForCirculationByISBN(request);
            }
            catch (Exception ex)
            {
                result.Status = AppServiceStatus.Fail;
                result.ErrorMessage = CommonErrorMessage.UnexpectedErrorMessage;
                Logger.WriteLog(ex, "CheckForCirculationByISBN");
            }
            return result;
        }

        [HttpPost]
        [Route("appservice/searchservice/GeteSupplierAccountNumberForAxis360")]
        public async Task<AppServiceResult<string>> GeteSupplierAccountNumberForAxis360(Axis360CheckCirculationRequest request)
        {
            var result = new AppServiceResult<string>();
            result.Status = AppServiceStatus.Success;
            try
            {
                result.Data = await _searchService.GeteSupplierAccountNumber(request);
            }
            catch (Exception ex)
            {
                result.Status = AppServiceStatus.Fail;
                result.ErrorMessage = CommonErrorMessage.UnexpectedErrorMessage;
                Logger.WriteLog(ex, "GeteSupplierAccountNumberForAxis360");
            }
            return result;
        }

        [HttpPost]
        [Route("appservice/searchservice/DiversityClassification")]
        public async Task<AppServiceResult<DiversityProductsResponse>> DiversityClassification([FromBody]DiversityProductsRequest diversityProductsRequest)
        {
            var result = new AppServiceResult<DiversityProductsResponse>();
            result.Status = AppServiceStatus.Success;
            try
            {
                result.Data = await _searchService.GetDiversityClassificationByBTKeys(diversityProductsRequest);
            }
            catch (Exception ex)
            {
                result.Status = AppServiceStatus.Fail;
                result.ErrorMessage = CommonErrorMessage.UnexpectedErrorMessage;
                Logger.WriteLog(ex, "DiversityClassification");
            }
            return result;
        }
    }
