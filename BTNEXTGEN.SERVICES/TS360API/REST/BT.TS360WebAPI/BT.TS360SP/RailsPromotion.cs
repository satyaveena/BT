...
{
    public class RailsPromotion : CMListBase<RailsPromotionItem>
    {
        public RailsPromotion()
        {
            HasAdName = true;
            RowLimit = 1;
        }
        ...
        //{
        //    return CMConstants.DefaultFieldNames + "<FieldRef Name='SalesTitle' /><FieldRef Name='SalesText' /><FieldRef Name='SalesPromoCode' /><FieldRef Name='PlacementType' />";
        //}
        ...
        protected override void IncludeFields(ClientContext clientContext, ListItemCollection listItems)
        {
            clientContext.Load(listItems, items => items.Include(
                       ...
                       item => item["Title"],
                       item => item["AdName"],
                       item => item["SalesTitle"],
                       item => item["SalesText"],
                       item => item["SalesPromoCode"],
