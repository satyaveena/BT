...
{
    public partial class CollectionCarouselItem : SingleProductBaseItem
    {
        ...
        {
            get { return string.IsNullOrEmpty(ESupplier) ? "false" : "true"; }
        }
    }
    ...
    public partial class CollectionCarouselItem : SingleProductBaseItem
    {
        ...
        public override void SPListItemMapping(ListItem item)
        {
            ...
            this.BTKEY = item["BTKEY"] as string;
            var temObject = item["Image"] as FieldUrlValue;
            this.Image = GetUrlFromFieldUrlValue(temObject == null ? "" : temObject.Url);
