namespace OAuthClient {
	...
	public partial class SampleWcf2 : System.Web.UI.Page {
        ...
        //    //TokenEndpoint = new Uri("http://localhost/TS360OAuthAuthorizationServer/OAuth/Token"),
        //    //AuthorizationEndpoint = new Uri("http://localhost/TS360OAuthAuthorizationServer/OAuth/Authorize"),
        //    AuthorizationEndpoint = new Uri("http://vmae743452:6581/_layouts/CommerceServer/OAuthSSOAuthorize.aspx"),
        //    TokenEndpoint = new Uri("http://vmae743452:6581/_layouts/CommerceServer/OAuthSSOToken.aspx")
        //};
		...
		static SampleWcf2() {
            ...
            Client.ClientCredentialApplicator = ClientCredentialApplicator.PostParameter("samplesecret");
            //Client.AuthorizationTracker = new OAuthClient.Code.TokenManager();           
		}
		...
		protected void getNameButton_Click(object sender, EventArgs e) {
			try {
                ...
                this.nameLabel.Text = ex.ToString();// "Access denied!";
			}
		}
        ...
        protected void getUserInfoButton_Click(object sender, EventArgs e)
        {
            try
            {
                var userInfoRes = this.CallService(client => client.GetUserInfo());
                this.userInfoLabel.Text = string.Join(", ", userInfoRes.UserName + ";" + userInfoRes.UserAlias);
            }
            catch (SecurityAccessDeniedException)
            {
		...
		private T CallService<T>(Func<DataApiClient, T> predicate) {
            ...
            var wcfClient = new DataApiClient("WSHttpBinding_IDataApi");
