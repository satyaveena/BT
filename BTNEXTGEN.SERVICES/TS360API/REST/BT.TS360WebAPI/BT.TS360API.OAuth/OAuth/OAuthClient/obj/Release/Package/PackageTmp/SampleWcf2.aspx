...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="Server">
	<fieldset title="Authorization">
		...
		<asp:CheckBoxList runat="server" ID="scopeList">
			<asp:ListItem Value="http://localhost/TS360OAuthResourceServer/IDataApi/GetName">GetName</asp:ListItem>
			<asp:ListItem Value="http://localhost/TS360OAuthResourceServer/IDataApi/GetAge">GetAge</asp:ListItem>
			<asp:ListItem Value="http://localhost/TS360OAuthResourceServer/IDataApi/GetFavoriteSites">GetFavoriteSites</asp:ListItem>
            <asp:ListItem Value="http://localhost/TS360OAuthResourceServer/IDataApi/GetUserInfo">GetUserInfo</asp:ListItem>
		</asp:CheckBoxList>
    ...
    <br />
    <asp:Button ID="getUserInfo" runat="server" Text="Get User Info" OnClick="getUserInfoButton_Click" />
