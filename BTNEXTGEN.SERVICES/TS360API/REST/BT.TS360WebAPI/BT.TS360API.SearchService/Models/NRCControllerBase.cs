...
namespace BT.TS360API.SearchService
{
    public abstract class NRCControllerBase
    {
        ...
        public abstract string GetCacheKey(ProductType productType);
        ...
        public List<NRCList> GetCachedData(out List<string> notInCacheProductTypes)
        {
            ...
            foreach (var productTypeId in ProductTypes)
            {
                ...
                if (Enum.TryParse<ProductType>(productTypeId, out productType))
                {
        ...
        private List<NRCList> GetCachedItemsByProductType(ProductType productType)
        {
        ...
        public void WriteItemsToCache(List<NRCList> items, ProductType productType)
        {
            var cacheKey = GetCacheKey(productType);
