...
namespace BT.ILSQueue.Business.MongDBLogger.ELMAHLogger
{
    ...
    public class ELMAHMongoLogger : ErrorLog
    {
        ...
        private static volatile ELMAHMongoLogger _instance;
        private static readonly object SyncRoot = new Object();
        public static ELMAHMongoLogger Instance
        {
            get
            {
                ...
                {
                    if (_instance == null)
                        _instance = new ELMAHMongoLogger();
                }
        ...
        public override String Log(Error error)
        {
            ...
            //error.Source = ApplicationConstants.ELMAH_ERROR_SOURCE_ILSQUEUE_BACKGROUND;
