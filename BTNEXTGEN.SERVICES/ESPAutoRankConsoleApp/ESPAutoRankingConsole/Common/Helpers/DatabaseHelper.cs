...
namespace ESPAutoRankingConsole.Common.Helpers
{
    public class DatabaseHelper
    {
        ...
        public static DataTable ConvertResponseRankedItemToSqlTable(ESPRankJsonResponse espRankJsonResponse, string basketSummaryID, string jsonResponse, string jobType, string stateType, string errorMessage)
        {
