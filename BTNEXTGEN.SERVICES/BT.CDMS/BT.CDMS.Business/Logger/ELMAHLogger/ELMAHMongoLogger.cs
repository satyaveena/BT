...
using BT.CDMS.Business.Logger.Log4Sites;
using Elmah;
using MongoDB.Bson;
...
namespace BT.CDMS.Business.Logger.ELMAHLogger
{
    ...
    public class ELMAHMongoLogger : ErrorLog
    {
        ...
        public override String Name => "CDMS API ELMAH MongoDB Error Log";
        ...
        private void Initialize()
        {
            ...
            IMongoDatabase database = new MongoClient(mongoUrl).GetDatabase(ApplicationConstants.APPLICATION_LOGDB);
